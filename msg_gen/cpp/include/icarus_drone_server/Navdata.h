/* Auto-generated by genmsg_cpp for file /home/dgitz/fuerte_workspace/sandbox/icarus_drone_server/msg/Navdata.msg */
#ifndef ICARUS_DRONE_SERVER_MESSAGE_NAVDATA_H
#define ICARUS_DRONE_SERVER_MESSAGE_NAVDATA_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Navdata_ {
  ...
  typedef boost::shared_ptr< ::icarus_drone_server::Navdata_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::icarus_drone_server::Navdata_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Navdata
typedef  ::icarus_drone_server::Navdata_<std::allocator<void> > Navdata;

typedef boost::shared_ptr< ::icarus_drone_server::Navdata> NavdataPtr;
typedef boost::shared_ptr< ::icarus_drone_server::Navdata const> NavdataConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::icarus_drone_server::Navdata_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::icarus_drone_server::Navdata_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::icarus_drone_server::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::icarus_drone_server::Navdata_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::icarus_drone_server::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "e1169f766234363125ac62c9a3f87eeb";
  }

  static const char* value(const  ::icarus_drone_server::Navdata_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xe1169f7662343631ULL;
  static const uint64_t static_value2 = 0x25ac62c9a3f87eebULL;
};

template<class ContainerAllocator>
struct DataType< ::icarus_drone_server::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
    return "icarus_drone_server/Navdata";
  }
...
template<class ContainerAllocator>
struct Definition< ::icarus_drone_server::Navdata_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::icarus_drone_server::Navdata_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::icarus_drone_server::Navdata_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::icarus_drone_server::Navdata_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::icarus_drone_server::Navdata_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::icarus_drone_server::Navdata_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // ICARUS_DRONE_SERVER_MESSAGE_NAVDATA_H
