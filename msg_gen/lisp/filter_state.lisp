...
(cl:defmethod cl:initialize-instance :after ((m <filter_state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'filter_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name icarus_drone_server-msg:<filter_state> is deprecated: use icarus_drone_server-msg:filter_state instead.")))
...
(cl:defmethod x-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:x-val is deprecated.  Use icarus_drone_server-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:y-val is deprecated.  Use icarus_drone_server-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:z-val is deprecated.  Use icarus_drone_server-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'dx-val :lambda-list '(m))
(cl:defmethod dx-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:dx-val is deprecated.  Use icarus_drone_server-msg:dx instead.")
  (dx m))

(cl:ensure-generic-function 'dy-val :lambda-list '(m))
(cl:defmethod dy-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:dy-val is deprecated.  Use icarus_drone_server-msg:dy instead.")
  (dy m))

(cl:ensure-generic-function 'dz-val :lambda-list '(m))
(cl:defmethod dz-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:dz-val is deprecated.  Use icarus_drone_server-msg:dz instead.")
  (dz m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:roll-val is deprecated.  Use icarus_drone_server-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:pitch-val is deprecated.  Use icarus_drone_server-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:yaw-val is deprecated.  Use icarus_drone_server-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'dyaw-val :lambda-list '(m))
(cl:defmethod dyaw-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:dyaw-val is deprecated.  Use icarus_drone_server-msg:dyaw instead.")
  (dyaw m))

(cl:ensure-generic-function 'scale-val :lambda-list '(m))
(cl:defmethod scale-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:scale-val is deprecated.  Use icarus_drone_server-msg:scale instead.")
  (scale m))

(cl:ensure-generic-function 'ptamState-val :lambda-list '(m))
(cl:defmethod ptamState-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:ptamState-val is deprecated.  Use icarus_drone_server-msg:ptamState instead.")
  (ptamState m))

(cl:ensure-generic-function 'scaleAccuracy-val :lambda-list '(m))
(cl:defmethod scaleAccuracy-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:scaleAccuracy-val is deprecated.  Use icarus_drone_server-msg:scaleAccuracy instead.")
  (scaleAccuracy m))

(cl:ensure-generic-function 'droneState-val :lambda-list '(m))
(cl:defmethod droneState-val ((m <filter_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:droneState-val is deprecated.  Use icarus_drone_server-msg:droneState instead.")
  (droneState m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<filter_state>)))
  ...
  "icarus_drone_server/filter_state")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'filter_state)))
  "Returns string type for a message object of type 'filter_state"
  "icarus_drone_server/filter_state")
