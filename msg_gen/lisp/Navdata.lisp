...
(cl:defmethod cl:initialize-instance :after ((m <Navdata>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Navdata)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name icarus_drone_server-msg:<Navdata> is deprecated: use icarus_drone_server-msg:Navdata instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:header-val is deprecated.  Use icarus_drone_server-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'batteryPercent-val :lambda-list '(m))
(cl:defmethod batteryPercent-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:batteryPercent-val is deprecated.  Use icarus_drone_server-msg:batteryPercent instead.")
  (batteryPercent m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:state-val is deprecated.  Use icarus_drone_server-msg:state instead.")
  (state m))

(cl:ensure-generic-function 'magX-val :lambda-list '(m))
(cl:defmethod magX-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:magX-val is deprecated.  Use icarus_drone_server-msg:magX instead.")
  (magX m))

(cl:ensure-generic-function 'magY-val :lambda-list '(m))
(cl:defmethod magY-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:magY-val is deprecated.  Use icarus_drone_server-msg:magY instead.")
  (magY m))

(cl:ensure-generic-function 'magZ-val :lambda-list '(m))
(cl:defmethod magZ-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:magZ-val is deprecated.  Use icarus_drone_server-msg:magZ instead.")
  (magZ m))

(cl:ensure-generic-function 'pressure-val :lambda-list '(m))
(cl:defmethod pressure-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:pressure-val is deprecated.  Use icarus_drone_server-msg:pressure instead.")
  (pressure m))

(cl:ensure-generic-function 'temp-val :lambda-list '(m))
(cl:defmethod temp-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:temp-val is deprecated.  Use icarus_drone_server-msg:temp instead.")
  (temp m))

(cl:ensure-generic-function 'wind_speed-val :lambda-list '(m))
(cl:defmethod wind_speed-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:wind_speed-val is deprecated.  Use icarus_drone_server-msg:wind_speed instead.")
  (wind_speed m))

(cl:ensure-generic-function 'wind_angle-val :lambda-list '(m))
(cl:defmethod wind_angle-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:wind_angle-val is deprecated.  Use icarus_drone_server-msg:wind_angle instead.")
  (wind_angle m))

(cl:ensure-generic-function 'wind_comp_angle-val :lambda-list '(m))
(cl:defmethod wind_comp_angle-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:wind_comp_angle-val is deprecated.  Use icarus_drone_server-msg:wind_comp_angle instead.")
  (wind_comp_angle m))

(cl:ensure-generic-function 'rotX-val :lambda-list '(m))
(cl:defmethod rotX-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:rotX-val is deprecated.  Use icarus_drone_server-msg:rotX instead.")
  (rotX m))

(cl:ensure-generic-function 'rotY-val :lambda-list '(m))
(cl:defmethod rotY-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:rotY-val is deprecated.  Use icarus_drone_server-msg:rotY instead.")
  (rotY m))

(cl:ensure-generic-function 'rotZ-val :lambda-list '(m))
(cl:defmethod rotZ-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:rotZ-val is deprecated.  Use icarus_drone_server-msg:rotZ instead.")
  (rotZ m))

(cl:ensure-generic-function 'altd-val :lambda-list '(m))
(cl:defmethod altd-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:altd-val is deprecated.  Use icarus_drone_server-msg:altd instead.")
  (altd m))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:vx-val is deprecated.  Use icarus_drone_server-msg:vx instead.")
  (vx m))

(cl:ensure-generic-function 'vy-val :lambda-list '(m))
(cl:defmethod vy-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:vy-val is deprecated.  Use icarus_drone_server-msg:vy instead.")
  (vy m))

(cl:ensure-generic-function 'vz-val :lambda-list '(m))
(cl:defmethod vz-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:vz-val is deprecated.  Use icarus_drone_server-msg:vz instead.")
  (vz m))

(cl:ensure-generic-function 'ax-val :lambda-list '(m))
(cl:defmethod ax-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:ax-val is deprecated.  Use icarus_drone_server-msg:ax instead.")
  (ax m))

(cl:ensure-generic-function 'ay-val :lambda-list '(m))
(cl:defmethod ay-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:ay-val is deprecated.  Use icarus_drone_server-msg:ay instead.")
  (ay m))

(cl:ensure-generic-function 'az-val :lambda-list '(m))
(cl:defmethod az-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:az-val is deprecated.  Use icarus_drone_server-msg:az instead.")
  (az m))

(cl:ensure-generic-function 'motor1-val :lambda-list '(m))
(cl:defmethod motor1-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:motor1-val is deprecated.  Use icarus_drone_server-msg:motor1 instead.")
  (motor1 m))

(cl:ensure-generic-function 'motor2-val :lambda-list '(m))
(cl:defmethod motor2-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:motor2-val is deprecated.  Use icarus_drone_server-msg:motor2 instead.")
  (motor2 m))

(cl:ensure-generic-function 'motor3-val :lambda-list '(m))
(cl:defmethod motor3-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:motor3-val is deprecated.  Use icarus_drone_server-msg:motor3 instead.")
  (motor3 m))

(cl:ensure-generic-function 'motor4-val :lambda-list '(m))
(cl:defmethod motor4-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:motor4-val is deprecated.  Use icarus_drone_server-msg:motor4 instead.")
  (motor4 m))

(cl:ensure-generic-function 'tags_count-val :lambda-list '(m))
(cl:defmethod tags_count-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tags_count-val is deprecated.  Use icarus_drone_server-msg:tags_count instead.")
  (tags_count m))

(cl:ensure-generic-function 'tags_type-val :lambda-list '(m))
(cl:defmethod tags_type-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tags_type-val is deprecated.  Use icarus_drone_server-msg:tags_type instead.")
  (tags_type m))

(cl:ensure-generic-function 'tags_xc-val :lambda-list '(m))
(cl:defmethod tags_xc-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tags_xc-val is deprecated.  Use icarus_drone_server-msg:tags_xc instead.")
  (tags_xc m))

(cl:ensure-generic-function 'tags_yc-val :lambda-list '(m))
(cl:defmethod tags_yc-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tags_yc-val is deprecated.  Use icarus_drone_server-msg:tags_yc instead.")
  (tags_yc m))

(cl:ensure-generic-function 'tags_width-val :lambda-list '(m))
(cl:defmethod tags_width-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tags_width-val is deprecated.  Use icarus_drone_server-msg:tags_width instead.")
  (tags_width m))

(cl:ensure-generic-function 'tags_height-val :lambda-list '(m))
(cl:defmethod tags_height-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tags_height-val is deprecated.  Use icarus_drone_server-msg:tags_height instead.")
  (tags_height m))

(cl:ensure-generic-function 'tags_orientation-val :lambda-list '(m))
(cl:defmethod tags_orientation-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tags_orientation-val is deprecated.  Use icarus_drone_server-msg:tags_orientation instead.")
  (tags_orientation m))

(cl:ensure-generic-function 'tags_distance-val :lambda-list '(m))
(cl:defmethod tags_distance-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tags_distance-val is deprecated.  Use icarus_drone_server-msg:tags_distance instead.")
  (tags_distance m))

(cl:ensure-generic-function 'tm-val :lambda-list '(m))
(cl:defmethod tm-val ((m <Navdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader icarus_drone_server-msg:tm-val is deprecated.  Use icarus_drone_server-msg:tm instead.")
  (tm m))
